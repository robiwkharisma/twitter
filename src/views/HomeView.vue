        ...
        <div class="col-sm-8">
              ...
              <div class="w-100">
                ...
                <div class="text-left">
                  <b-badge pill variant="primary" class="py-1">
                    ...
                    <label class="m-0">Everyone can see</label>
                  </b-badge>
                </div>
                <hr class="my-2">
                <div class="row">
          ...
          <div
              ...
              <div class="d-flex">
                ...
                <div class="w-100">
                  <div class="text-left p-2">
                    <h6 class="m-0"><strong>Robi W Kharisma</strong></h6>
                    <span style="font-size: 14px; color: #71767B">@robiwkharisma</span>
                    <span style="color: #71767B"> · </span>
                    <span style="font-size: 14px; color: #71767B">{{dateFormat(item.time)}}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-footer">
              <div class="d-flex px-2 justify-content-between" style="font-size: 13px;">
                <div class="comment" style="cursor: pointer;">
                  ...
                  <span class="px-2">{{item.comments}}</span>
                </div>
                <div class="retweet"  style="cursor: pointer;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
                  </svg>
                  <span class="px-2">{{item.retweets}}</span>
                </div>
                <div class="love"  style="cursor: pointer;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                    <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                  </svg>
                  <span class="px-2">{{item.loves}}</span>
                </div>
  ...
  methods: {
    async saveTweet() {
      if (this.form.tweet) {
        ...
        await this.$store.dispatch("saveTweet", {
          params: params,
        });
      }
      await this.clearTweet()
    },
    clearTweet() {
      this.form.tweet = null
    },
    dateFormat(time) {
