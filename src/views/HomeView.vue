      ...
      <b-row>
        ...
        <div class="col-sm-8">
              ...
              <div class="w-100">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 text-sm-right">
                    <b-button pill variant="primary"><strong>Tweet</strong></b-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card p-0 text-left">
              ...
              <div class="d-flex">
                ...
                <div class="w-100">
                  <div class="text-left p-2">
                    ...
                    <span style="font-size: 14px; color: #71767B">18h</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="px-2">
                from “come over” to “come home” is a relationship goal for me
              </div>
            </div>
